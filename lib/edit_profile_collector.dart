...
class ProfileEditCollectorScreen extends StatefulWidget {
  const ProfileEditCollectorScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ProfileEditCollectorScreenState createState() =>
      _ProfileEditCollectorScreenState();
}

class _ProfileEditCollectorScreenState
    extends State<ProfileEditCollectorScreen> {
